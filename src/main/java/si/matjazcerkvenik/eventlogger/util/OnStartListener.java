...
public class OnStartListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent servletContextEvent) {
        ...
        DProps.EVENTLOGGER_REQUEST_PROCESSING_WORKERS = Integer.parseInt(System.getenv().getOrDefault("EVENTLOGGER_REQUEST_PROCESSING_WORKERS", "" + Runtime.getRuntime().availableProcessors()).trim());
